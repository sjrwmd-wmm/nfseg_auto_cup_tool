...
class ConvFactors:
    def __init__(self):
        ...
        self.cfd2gd = 1.0 / self.gd2cfd
        self.cfs2gs = 1.0 / self.gs2cfs
        ...
        self.cfd2mgd = self.cfd2gd/(1.0e6) # Most accurate version
        ...
        self.mgd2cfs = self.mgd2cfd / self.day2sec # Most accurate version
        #
        #
        ...
        self.cfs2mgd = self.cfd2mgd * self.day2sec # Most accurate version
